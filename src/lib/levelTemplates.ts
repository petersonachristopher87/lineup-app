...
export interface LevelTemplate {
  ...
  equityWeights: {
    playing_time: 'low' | 'medium' | 'high'
    position_variety: 'low' | 'medium' | 'high'
    batting_order_rotation: 'low' | 'medium' | 'high'
    infield_outfield_balance: 'low' | 'medium' | 'high'
  }
  safetyRules: {
...
export const LEVEL_TEMPLATES: Record<string, LevelTemplate> = {
  single_a: {
    name: 'Single-A (Coach Pitch, ~6-7 yrs)',
    fielders: 9,
  ...
  aa: {
    name: 'AA (Kid Pitch Introduced, ~8-9 yrs)',
    fielders: 9,
    continuousBattingOrder: true,
    inningsPerGame: 6,
    equityWeights: {
